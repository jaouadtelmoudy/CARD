<template>  
    ...
    <div class="col-md-3" v-for="(card, i) in cardLists" :key="i">
      <div class="card-view">
          <div class='bg'>
            <img src="../../public/images/avatar.jpg" alt="company image">
          </div>
        <div class="container">
          <a href='#'><div class="tag_name red">{{card.designation}}</div></a>
          <div class="company">       
            <div class="c_content">
              <p class="review">{{card.description}}</p>
            </div>
          </div> <!-- end .company -->

          <div class="user">            
            <div class="user_info">
              <a href="#" class="user_name orange">Crée le</a> {{card.dateCreate}}
            </div>
          </div> <!-- end .user -->
        </div> <!-- end .container -->
      </div> <!-- end card -->
...
import RESULT from '../mocks/mocks.js'
